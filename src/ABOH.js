...
export default function ABOH() {
	...
	const questions = [
		...
		{
			questionText: 'Which of the following is NOT associated with acquired B antigen?',
			answerOptions: [
		...
		{
			questionText: 'ABO antigens are sensitive to which of the following chemical treatments?',
			answerOptions: [
		...
		{
			questionText: 'Which of the following is NOT a possible cause of mixed-field agglutination?',
			answerOptions: [
				{ answerText: 'Depressed immunoglobulin levels in immunodeficient patients', isCorrect: true },
		...
		{
			questionText: 'E. coli O86 is the heterophile antigen that causes us to make "naturally occurring":',
			answerOptions: [
		...
		{
			questionText: 'How would you resolve rouleaux interference in an ABO type?',
			answerOptions: [
		...
		{
			questionText: 'Anti-A1 is considered clinically insignificant unless it reacts at:',
			answerOptions: [
		...
		{
			questionText: 'What test serologically distinguishes A1 from other subgroups of A?',
			answerOptions: [
		...
		{
			questionText: 'Acquired B antigen is a phenomenon that can occasionally be seen in individuals with blood group:',
			answerOptions: [
		...
		<div class="transbox">
			...
			<div className='app'>
				{showScore ? (
					...
					<br/>
					<a href="/ABO" class="button">Retry</a>
					<br/>
