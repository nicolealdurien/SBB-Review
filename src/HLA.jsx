...
export default function HLA() {
  ...
  const questions = [
    ...
    {
      questionText:
        'HLA Class II molecules are recognized by which type of T cell?',
      answerOptions: [
    ...
    {
      questionText:
        'In which of the following clinical conditions is HLA *least* important as a consideration?',
      answerOptions: [
        ...
        {
          answerText: 'Alloimmunization in sickle cell disease',
          isCorrect: true,
        },
      ],
    },
    {
      questionText:
        'Which HLA class is found on platelets and almost all nucleated cells in the body?',
      answerOptions: [
    ...
    {
      questionText:
        'ABO compatibility is more important than HLA compatibility for which types of transplants?',
      answerOptions: [
    ...
    {
      questionText:
        'HLA Class I molecules are recognized by which type of T cell?',
      answerOptions: [
    ...
    {
      questionText:
        'Which 2 complement proteins are also HLA class III proteins and RBC antigens?',
      answerOptions: [
    ...
    {
      questionText:
        'Which HLA class is found only on B-lymphocytes, macrophages, dendritic cells, and activated T cells?',
      answerOptions: [
    ...
    {
      questionText:
        'How would a serologic lymphocytotoxicity cell death score of 18% be interpreted?',
      answerOptions: [
    ...
    {
      questionText:
        'What "cellular crossmatch" test is rarely used but involves culturing lymphocytes from 2 individuals together?',
      answerOptions: [
    ...
    {
      questionText:
        'What condition involves HLA antibodies in donor plasma reacting with and fixing complement to recipient granulocytes, leading to severe capillary leakage and pulmonary edema?',
      answerOptions: [
    ...
    {
      questionText:
        'Which class of HLA molecules present exogenous/extracellular peptides?',
      answerOptions: [
        { answerText: 'HLA Class I', isCorrect: false },
        { answerText: 'HLA Class II', isCorrect: true },
        { answerText: 'HLA Class III', isCorrect: false },
